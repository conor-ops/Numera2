...
const BankInput: React.FC<BankInputProps> = ({ accounts, onUpdate, isPro = false, onUpgradeClick, defaultExpanded = true }) => {
    ...
    <div className="p-4 md:p-6 bg-white border-2 border-black shadow-swiss flex flex-col">
      ...
      >
        ...
        <div className="flex items-center gap-4">
          ...
          <button 
            onClick={addAccount}
            className={`p-1 hover:bg-gray-100 rounded-sm transition-colors ${canAddMore ? 'text-gray-400 hover:text-brand-blue' : 'text-gray-300 cursor-not-allowed'}`}
          >
            <Plus size={20} />
          </button>
        </div>
