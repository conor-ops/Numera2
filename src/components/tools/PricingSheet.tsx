...
=======
  ...
  useEffect(() => {
    const saved = JSON.parse(localStorage.getItem('Solventless_cogs') || '[]') as LineItem[];
...
=======
    ...
    const existingCogs = JSON.parse(localStorage.getItem('Solventless_cogs') || '[]') as LineItem[];
    localStorage.setItem('Solventless_cogs', JSON.stringify([...existingCogs, item]));
  ...
  const removeLineItem = (id: string) => {
    ...
    localStorage.setItem('Solventless_cogs', JSON.stringify(updated));
  };
...
───────────────────────────────────────────────────────────────
Generated by Solventless - Business Finance Platform
═══════════════════════════════════════════════════════════════
>>>>>>> 77ba376b604355ede97c1706d992f9306b3b7b4a
    `.trim();
            ...
            <button
              onClick={() => {
                if (window.confirm('Clear all line items? This cannot be undone.')) {
                  ...
                  setClientName('');
                  setProjectName('');
                  localStorage.removeItem('Solventless_cogs');
                }
              }}
