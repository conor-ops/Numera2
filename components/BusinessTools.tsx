...
const BusinessTools: React.FC<BusinessToolsProps> = ({ 
  ...
  if (activeView === 'PRICING') return <PricingCalculator onClose={() => setActiveView('PORTAL')} isPro={isPro} onShowPaywall={onShowPaywall} />;
